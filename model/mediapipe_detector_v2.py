...
class MediaPipeHolisticDetector:
    ...
    def __init__(self, min_detection_confidence=0.5):
        ...
        self.__holistic = self.__mp_holistic.Holistic(static_image_mode=True, model_complexity=2,
    ...
    def detect_pose(self, pil_image):
        ...
        return {'body': self.__convert_body_keypoints(results.pose_landmarks, image_width, image_height),
